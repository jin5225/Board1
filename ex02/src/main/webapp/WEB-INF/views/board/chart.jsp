...
<body>
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse collapse">
                    <ul class="nav" id="side-menu">
                        <li class="sidebar-search">
                            <div class="input-group custom-search-form">
                            	<form action="/board/list" method="get">
                                	...
                                	<input type="text" name="keyword"  placeholder="게시판 검색" id="keyword" value="${pageMaker.cri.keyword}">
                        ...
                        <li>
                            <a href="/board/chart"><i class="fa fa-bar-chart-o fa-fw"></i> 차트</a>
                        </li>
                        <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">게시판 이용 통계</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
